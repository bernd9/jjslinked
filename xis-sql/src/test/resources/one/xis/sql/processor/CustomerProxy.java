...
public class CustomerProxy extends Customer implements EntityProxy<Customer, Long> {
    ...
    private final FieldValueLoader<Long, List<Agent>> agentsLoader = new FieldValueLoader<Long, List<Agent>>(key ->  CustomerAgentCrossTableAccessor.getInstance().getJoinedFieldValues(key, java.util.List.class));
